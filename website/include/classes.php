...
class Application {
    ...
    public function auditlog($context, $message, $priority = 0, $userid = NULL){
        ...
        $url = "https://xz5at7hgsa.execute-api.us-east-1.amazonaws.com/default/Auditlog";
  			...
  			curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/json', 'x-api-key: XI70GJDCXIg9NRwzHt62Kopv2hyYNW8l8B3WTV8','Content-Length: ' . strlen($data_json)));
   ...
   protected function sendValidationEmail($userid, $email, &$errors) {
        ...
        if ($response === FALSE) {
          ...
          if($httpCode == 400) {
            ...
            $headers = 'From: mj03382@growinginyou.me' . "\r\n" .
