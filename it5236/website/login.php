...
<body>
	...
	<div>
		<form method="post" id="usernameForm" action="login.php">
			...
			<input type="checkbox" value="checkbox" id="saveLocal" name="saveLocal" /> Remember Me 
		</form>
	</div>
